...
class TitleCard extends React.Component {
  ...
  render() {
    ...
    if (this.props.link) {
      headingElement = <h2 className='title-card__title'><a href={this.props.link} target='_blank' rel='noopener noreferrer'>{this.props.name}</a></h2>;
    } else {
          ...
          <div className="title-card__vertical-align">
            ...
            {weatherData.url &&
              <a href={weatherData.url} className="weather-data" target="_blank">
                <ul>
                  {weatherData.temp &&
                    <li>{weatherData.temp} <small>°f</small></li>
                  }
                  ...
                  {weatherData.elevation &&
                    <li>{weatherData.elevation}' <small>Elevation</small></li>
                  }
                  {weatherData.clouds &&
